...
protocol ObservableCancellableProtocol {
    func cancel()
}
...
public class ObservableCancellable: ObservableCancellableProtocol, Hashable {
    ...
    public static func == (lhs: ObservableCancellable, rhs: ObservableCancellable) -> Bool {
        lhs.hashValue == rhs.hashValue
    }
    func cancel() {}
    
    public func store(_ set: inout Set<ObservableCancellable>) {
    ...
    deinit {
        print("ObservedsAnyCancellable:  \(identifier) is deinit")
    }
...
@propertyWrapper
public class ObservableStructure<T> {
